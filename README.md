...
- Login via LinkedIn/IEEE or using your site profile ID
...
7. Visit `/register.html` to sign in with LinkedIn, IEEE, or your university ID.
8. From the login page, follow the sign-up link to `/signup.html` and create a student profile.
