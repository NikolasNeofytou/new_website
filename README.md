...
- Student profiles with university ID, dropdown year and specialization, and photo upload with electrical engineering themed defaults (stored privately)
...
7. Visit `/profiles.html` to create a student profile.
